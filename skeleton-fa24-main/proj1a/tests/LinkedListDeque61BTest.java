...
public class LinkedListDeque61BTest {
    ...
    @Test
    /** This test test the method isEmpty() */
    ...
    public void getTest(){
        ...
        assertThat(lld1.get(777)).isEqualTo(null);
        lld1.addLast(2);
    ...
    public void getRecursiveTest(){
        ...
        assertThat(lld1.getRecursive(777)).isEqualTo(null);
        lld1.addLast(2);
        assertThat(lld1.getRecursive(1)).isEqualTo(2);
    }

    @Test
    /** This test test the removeFirst() method */
    ...
    @Test
    /** This test test the removeLast() method */
    public void removeLastTest(){
        ...
        assertThat(lld1.toList()).containsExactly(5,4,3).inOrder();
    }
}